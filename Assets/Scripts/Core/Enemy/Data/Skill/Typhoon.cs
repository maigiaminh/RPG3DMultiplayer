...
[CreateAssetMenu(fileName = "Typhoon", menuName = "Enemy/Skill/Typhoon", order = 1)]
public class Typhoon : SkillData
{
    ...
    {
        Typhoon Instance = CreateInstance<Typhoon>();
    ...
    IEnumerator ActivateSkill(Enemy enemy, IDamageable damageable)
    {
        ...
        {
            Debug.LogError("Typhoon: No ground found");
        }

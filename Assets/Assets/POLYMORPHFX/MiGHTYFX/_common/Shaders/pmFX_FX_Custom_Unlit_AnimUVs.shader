...
Shader "pmFX/FX/FX_Custom_Unlit_animUVLayers"
{
	...
	SubShader
	{
		...
		{
			float2 TexCoordWT127 = (i.uv_texcoord).zw;
			float2 uvs_TexCoord94 = i.uv_texcoord;
			uvs_TexCoord94.xy = i.uv_texcoord.xy * (_TextureTiling).xy + TexCoordWT127;
			float2 panner96 = ( 1.0 * _Time.y * (_TextureSpeed).xy + uvs_TexCoord94.xy);
			float4 tex2DNode72 = tex2D( _MainTex, panner96 );
			float2 uvs_TexCoord98 = i.uv_texcoord;
			uvs_TexCoord98.xy = i.uv_texcoord.xy * (_TextureTiling).zw + TexCoordWT127;
			float2 panner102 = ( 1.0 * _Time.y * (_TextureSpeed).zw + uvs_TexCoord98.xy);
			...
			#endif
			float4 saferPower73 = abs( ( ( tex2DNode72 + staticSwitch89 ) * _TintColor ) );
			...
			float saferPower135 = abs( tex2D( _Mask, uv_Mask ).r );
			float Opacity140 = ( _MaskOpacity * saturate( pow( saferPower135 , _MaskPower ) ) );
			float2 uvs_TexCoord118 = i.uv_texcoord;
			uvs_TexCoord118.xy = i.uv_texcoord.xy * (_AlphaTiling).xy + TexCoordWT127;
			float2 panner122 = ( 1.0 * _Time.y * (_AlphaSpeed).xy + uvs_TexCoord118.xy);
			float4 tex2DNode145 = tex2D( _AlphaTexture, panner122 );
			float2 uvs_TexCoord119 = i.uv_texcoord;
			uvs_TexCoord119.xy = i.uv_texcoord.xy * (_AlphaTiling).zw + TexCoordWT127;
			float2 panner121 = ( 1.0 * _Time.y * (_AlphaSpeed).zw + uvs_TexCoord119.xy);
			#ifdef _2NDALPHA_ON
...
/*ASEBEGIN
Version=18921
176;453;1971;936;-821.7294;1409.359;1.623591;True;True
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;176;3012.516,-929.6129;Float;False;True;-1;7;ASEMaterialInspector;0;0;Unlit;pmFX/FX/FX_Custom_Unlit_animUVLayers;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;False;False;False;False;False;Back;2;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Custom;;Transparent;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;1;0;True;43;0;True;45;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;0;-1;-1;-1;0;False;0;0;True;76;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=CEDA7C911659AD7A483560AA34689F0CCAA80DA1